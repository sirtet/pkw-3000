...
;           dp (decimal point, normally bottom-right)
;--------------------------------------------------------------------
A0399:	DB		03FH,006H,05BH,04FH		; 0 1 2 3
...
;
;--------------------------------------------------------------------
; Keys, see manual Page 3-26 (50)
; ? RST Key unclear, is it FF?
;--------------------------------------------------------------------

A03B2:	DB		005H,00BH,013H,012H		;   5,   B,  PRG,  SET
		DB		009H,00FH,017H,011H		;   9,   F,  JOB,    -
		DB		00DH,002H,016H,0FFH		;   D,   2,  CMP
		DB		000H,006H,015H,0FFH		;   0,   6,  ERS
		DB		004H,00AH,014H,0FFH		;   4,   A,  LOD
		DB		008H,00EH,003H,0FFH		;   8,   E,    3
		DB		00CH,001H,007H,0FFH		;   C,   1,    7
;--------------------------------------------------------------------
;
;--------------------------------------------------------------------
PR03CE:	PUSH	PSW				;
