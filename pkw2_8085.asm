...
;8155
;------------------------------------------------------------------------------
CMDSTA:	EQU		068H		;COMMAND/STATUS
LEDSEG:	EQU		069H		;PA				Display Output
DKSELB:	EQU		06AH		;PB				Disp.-Nr / Key-Col SELECT / Beeper
...
;   It reads from PORTB... 
;   ... After setting the Key COL to read (OUT LEDSEG) see also PR020B
